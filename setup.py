...
class PreInstallCommand(install):
    ...
    def run(self):
        ...
        check_call("python3 -m pip install cyhunspell pandas language_tool_python spacy scrapy itemadapter wheel numpy Twisted flask timeloop pytz nltk coverage scikit-learn matplotlib seaborn memory_profiler".split())
